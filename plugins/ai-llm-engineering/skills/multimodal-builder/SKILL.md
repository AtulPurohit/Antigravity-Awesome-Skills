---
name: multimodal-builder
description: "Professional Multimodal Builder skill. Integrate LLM API workflows, safe system prompt guidelines, and agentic workflows."
category: ai-ml
...
## Purpose
Manage and implement Multimodal Builder requirements efficiently within enterprise applications.

## Core Concepts
Detailed operational framework for Multimodal Builder:

### 1️⃣ Overview and Strategy
Understanding boundaries, rules, and best practices for the multimodal-builder feature domain.
