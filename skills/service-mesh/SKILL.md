---
name: service-mesh
description: "Professional Service Mesh Expert skill. Build performant, secure, and scalable backend logic and RESTful or GraphQL APIs."
category: backend
...
## Purpose
Manage and implement Service Mesh Expert requirements efficiently within enterprise applications.

## Core Concepts
Detailed operational framework for Service Mesh Expert:

### 1️⃣ Overview and Strategy
Understanding boundaries, rules, and best practices for the service-mesh feature domain.
