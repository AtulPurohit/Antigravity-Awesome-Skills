---
name: dx-auditor
description: "Professional Dx Auditor skill. Build performant, secure, and scalable backend logic and RESTful or GraphQL APIs."
category: backend
...
## Purpose
Manage and implement Dx Auditor requirements efficiently within enterprise applications.

## Core Concepts
Detailed operational framework for Dx Auditor:

### 1️⃣ Overview and Strategy
Understanding boundaries, rules, and best practices for the dx-auditor feature domain.
