---
name: embedding-architect
description: "Professional Embedding Architect skill. Integrate LLM API workflows, safe system prompt guidelines, and agentic workflows."
category: ai-ml
...
## Purpose
Manage and implement Embedding Architect requirements efficiently within enterprise applications.

## Core Concepts
Detailed operational framework for Embedding Architect:

### 1️⃣ Overview and Strategy
Understanding boundaries, rules, and best practices for the embedding-architect feature domain.
