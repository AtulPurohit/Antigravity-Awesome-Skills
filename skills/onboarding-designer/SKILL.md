...
description: "Professional Onboarding Designer skill. Build performant, secure, and scalable backend logic and RESTful or GraphQL APIs."
category: backend
...
## Purpose
Manage and implement Onboarding Designer requirements efficiently within enterprise applications.

## Core Concepts
Detailed operational framework for Onboarding Designer:

### 1️⃣ Overview and Strategy
Understanding boundaries, rules, and best practices for the onboarding-designer feature domain.
